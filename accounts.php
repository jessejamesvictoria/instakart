...
$check_display_username_query = "SELECT * FROM ig_accounts WHERE username = '$display_username' AND confirmed=1";
...
{
	echo "Buy Shoutout for ".$display_username;
}
?> </title>
</head>
<style>
...
<div class="container">
	 ...
	 {
		 $get_info_query = "SELECT score, account_description,account_amount, account_time FROM ig_accounts WHERE username = '$display_username'";
		$run_info_query = mysqli_query($conn, $get_info_query);
		$fetch_info_rows = mysqli_fetch_assoc($run_info_query);
		$score = $fetch_info_rows['score'];
	 ?>
     	<div class="col-sm-8">
        	<div class="col-xs-12 bg-info shoutout-info">
                ...
                <div class="col-sm-7 col-md-7 col-lg-8">
                	<div class="pull-left">
                     ...
                     <p> Score : <?php if($score == 0){ echo "<p class='text-muted'>N/A</p>";}else{ echo $score;} ?> </p>
                    </div>
                </div>
            </div>
            <div class="clearfix">
            ...
            <input type="hidden" value="<?php echo $display_username; ?>" name="username">
            </div>
            </div>
            </form>
        </div>
